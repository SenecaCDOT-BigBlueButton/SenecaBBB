                ...
                <div class="content">
                    <fieldset>
                        <div class="component">
                            ...
                            <input type="text" readonly name="key_name" id="key_name" class="input" tabindex="2"  value="<%= key_name %>" 
                          title="key_name" >
                          
                        </div>
                        <div class="component">
                            <label for="keytitle" class="label">Key title:</label>
                            <input type="text" readonly name="key_title" id="key_title" class="input" tabindex="3"  value="<%= key_title %>" 
                             title="key_title" >
                        </div>
                        <div class="component">
