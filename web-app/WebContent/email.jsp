...
<%
    ...
    if (guestemail != null) {
        ...
        viewerJoinURL = Config.getProperty("domain") + "guest_login.jsp?meetingId=" + meetingId;
        ...
        messageText = "<p>Dear Guest User:</p><p>You are invited to join an event in BigBlueButton web conferencing system."
                + "<p>Please visit the following link to join the conference:</p>"
                + viewerJoinURL
                + "<p>Event start date and time (ISO 8601): "
                + eventTime;
        ...
        link = Config.getProperty("domain") + "guest_setup.jsp?&key=" + key + "&user=" + bu_id;
        messageText = "<p>Dear Guest User:</p><p>You are invited to join an event in our web conferencing system. A guest account is created for you.</p><p> Your user name is: <strong>"
                + bu_id
                + "</strong></p><p> Please visit the following link to activate your account:</p>"
                + link;
