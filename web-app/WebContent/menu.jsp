    ...
    <ul>
      ...
      <% 
        if (usersession.isSuper()){
	        ...
	        out.write("<div class=\"menu\"><li id=\"systemSettings\"><a href=\"systemSettings.jsp\" tabindex=\"13\" title=\"Click here to manage system settings\">System Settings</a></li></div>");
        ...
        if (usersession.isDepartmentAdmin()){
        	out.write("<div class=\"menu\"><li id=\"departmentUsers\"><a href=\"departmentUsers.jsp\" tabindex=\"10\" title=\"Click here to manage department users\">Department Users</a></li></div>");	
        }
        if (usersession.isProfessor()){
        	out.write("<div class=\"menu\"><li id=\"classSettings\"><a href=\"classSettings.jsp\" tabindex=\"12\" title=\"Click here to manage class settings\">Class Settings</a></li></div>");
        }
        %>
    </ul>
  </nav>
