...
<%
    ...
    ArrayList<HashMap<String, String>> latestCreatedSchedule = new ArrayList<HashMap<String, String>>();
    ArrayList<HashMap<String, String>> latestCreatedMeeting = new ArrayList<HashMap<String, String>>();
    ...
    if (eventType.equals("Meeting")) { //create a meeting event		
        if (meeting.createMeetingSchedule(title, inidatetime, spec,duration, description, userId)) {
            if (fromquickmeeting != null) {
                ...
                meeting.getMeetingInfo(latestCreatedMeeting,latestCreatedSchedule.get(0).get("ms_id"));
                response.sendRedirect("add_attendee.jsp?successMessage= Quick Meeting created, please add attendees to your meeting&m_id="
                        + latestCreatedMeeting.get(0).get("m_id")
                        + "&ms_id="
                        + latestCreatedSchedule.get(0).get("ms_id"));
            } else {
