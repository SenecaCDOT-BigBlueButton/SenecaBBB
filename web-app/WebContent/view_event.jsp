                        ...
                        <div id="currentEventDiv" class="tableComponent">
                            <table id="currentEventS" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <% } %>
                                    <% if (status==1 || status==3) { %>
                                        <td class="icons" align="center"><a href="edit_event_schedule.jsp?&ms_id=<%= ms_id %>&m_id=<%= m_id %>&l_id=<%= l_id %>&ls_id=<%= ls_id %>" class="modify"><img src="images/iconPlaceholder.svg" width="17" height="17" title="Modify department name" alt="Modify"/></a></td>
                                    <% } %>
                                    </tr>
                                </tbody>
                            </table>
